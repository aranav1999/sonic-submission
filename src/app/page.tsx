  ...
  return (
    <>
        ...
        <div className="w-[50%] flex flex-col ">
          <div className="flex flex-col  -space-y-2">
            ...
            <span className="text-[40px] font-medium">
              Attention is{" "}
              <span className="text-[#ff9ec6] text-[60px]">MONEY</span>.
            </span>
          ...
          <div className="w-[70%]  flex flex-row space-x-4 items-center justify-between mt-6">
            <Link href="/creators" className="w-[50%]" passHref>
              <div className="relative border cursor-pointer border-[#26171d] text-center rounded-md bg-gradient-to-b from-[#ff9ec6] to-[#ff9ec6] text-[#1f151c] text-[13px] font-medium tracking-wide py-2 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl overflow-hidden group">
      ...
      <div className="w-full py-16 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black via-[#1f151c]/80 to-black" style={{
        ...
        {/* Soft glow effects */}
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-[#ff9ec6]/5 blur-[120px] rounded-full opacity-60"></div>
        <div className="absolute left-1/4 top-1/3 w-[50%] h-[50%] bg-[#9b5de5]/5 blur-[100px] rounded-full opacity-50"></div>
        <div className="absolute right-1/4 bottom-1/3 w-[50%] h-[50%] bg-[#ff9ec6]/5 blur-[100px] rounded-full opacity-50"></div>

        <div className="max-w-7xl mx-auto px-8 relative z-10">
          <h2 className="text-center text-4xl font-bold mb-12 text-white">
            How It <span className="text-[#ff9ec6]">Works</span>
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* For Users Box */}
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#2a1b23]/90 via-[#251920]/80 to-[#1f151c]/70 p-8 shadow-xl backdrop-blur-sm border border-[#3a2a33]/20 transition-all duration-300 hover:shadow-2xl hover:border-[#ff9ec6]/20 group">
              <div className="absolute -top-20 -right-20 w-64 h-64 bg-[#ff9ec6] opacity-5 blur-[80px] rounded-full group-hover:opacity-10 transition-all duration-700"></div>
              ...
              <h3 className="text-2xl font-bold mb-6 text-[#ff9ec6] bg-clip-text text-transparent bg-gradient-to-r from-[#ff9ec6] to-[#ff9ec6]/80">For Users</h3>

              <div className="space-y-6 relative z-10">
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-[#ff9ec6]/30 to-[#ff9ec6]/10 flex items-center justify-center mr-4 shadow-inner">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#ff9ec6]" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#2a1b23]/90 via-[#251920]/80 to-[#1f151c]/70 p-8 shadow-xl backdrop-blur-sm border border-[#3a2a33]/20 transition-all duration-300 hover:shadow-2xl hover:border-[#ff9ec6]/20 group">
              ...
              <h3 className="text-2xl font-bold mb-6 text-[#ff9ec6] bg-clip-text text-transparent bg-gradient-to-r from-[#ff9ec6] to-[#ff9ec6]/80">For Creators</h3>
          ...
          <div className="mt-12 text-center">
            <Link href="/creators" passHref>
              <div className="inline-block relative border-none cursor-pointer text-center rounded-full bg-gradient-to-r from-[#ff9ec6] to-[#ff7eb6] text-[#1f151c] text-[15px] font-medium tracking-wide py-3 px-10 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl overflow-hidden group">
