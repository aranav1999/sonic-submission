        ...
        <div className="max-w-7xl mx-auto px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#0e211c]/90 via-[#0b0f0f]/80 to-[#0e1f1a]/70 p-8 shadow-xl backdrop-blur-sm border border-[#0a0f0f]/20 transition-all duration-300 hover:shadow-2xl hover:border-[#1ab071]/20 group">
              ...
              <h3 className="text-2xl font-bold mb-6 text-[#1ab071] bg-clip-text text-transparent bg-gradient-to-r from-[#1ab071] to-[#1ab071]/80">For Users</h3>
              ...
              <div className="space-y-6 relative z-10">
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-[#1ab071]/30 to-[#1ab071]/10 flex items-center justify-center mr-4 shadow-inner">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#1ab071]" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#0e211c]/90 via-[#0b0f0f]/80 to-[#0e1f1a]/70 p-8 shadow-xl backdrop-blur-sm border border-[#0a0f0f]/20 transition-all duration-300 hover:shadow-2xl hover:border-[#1ab071]/20 group">
              ...
              <h3 className="text-2xl font-bold mb-6 text-[#1ab071] bg-clip-text text-transparent bg-gradient-to-r from-[#1ab071] to-[#1ab071]/80">For Creators</h3>
