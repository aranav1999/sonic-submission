            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
              {posts.length === 0 ? (
                ...
                posts.map((post) => {
                  ...
                  return (
                    <div key={post._id} className="relative overflow-hidden rounded-xl bg-gradient-to-br from-[#2f1f25]/90 to-[#1f151c]/90 border border-[#3a2a33]/30 shadow-lg transition-all duration-300 hover:shadow-[0_0_15px_rgba(255,158,198,0.2)] hover:translate-y-[-5px]">
                        ...
                        <div className="h-full flex flex-col">
                          ...
                          <div className="p-4 flex-1 flex flex-col">
                            <p className="text-white font-medium mb-2 flex items-center">
                              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 text-[#ff9ec6]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                              </svg>
